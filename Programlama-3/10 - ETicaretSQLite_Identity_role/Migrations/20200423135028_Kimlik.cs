    ...
    public partial class Kimlik : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KategorilerVeUrunleri", x => new { x.KategoriId, x.UrunId });
                    table.ForeignKey(
                        name: "FK_KategorilerVeUrunleri_Kategoriler_KategoriId",
                        column: x => x.KategoriId,
                        principalTable: "Kategoriler",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KategorilerVeUrunleri_Urunler_UrunId",
                        column: x => x.UrunId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KategorilerVeUrunleri_UrunId",
                table: "KategorilerVeUrunleri",
                column: "UrunId");
